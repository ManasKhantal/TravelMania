...
<body>
    ...
    <div class="boxes">
        <div class="box"><img src="images/20.jpg" alt=""height="200px" width="250px" style="margin-top: 10px; border-radius: 5px;"><a href="booked_buses.php" class="book">My Buses Bookings</a></div>
        <div class="box"><img src="images/22.jpg" alt=""height="200px" width="250px" style="margin-top: 10px; border-radius: 5px;"><a href="booked_hotels.php" class="book">My Hotel Bookings</a></div>
        <div class="box"><img src="images/21.jpg" alt=""height="200px" width="250px" style="margin-top: 10px; border-radius: 5px;"><a href="booked_flights.php" class="book">My Flight Bookings</a></div>
    </div>
